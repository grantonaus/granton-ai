    ...
    return (
        <section className="relative w-full overflow-hidden flex flex-col items-center text-center px-5 pt-52 pb-10">
            ...
            <motion.h1
                ...
                className="pb-8 max-w-5xl text-[40px] sm:text-[56px] md:text-[72px] font-extrabold leading-[0.95] bg-gradient-to-b from-white to-white/20 bg-clip-text text-transparent"
            >
                Find the perfect{" "}
            ...
            <motion.p
                ...
                className="max-w-3xl font-medium text-[19px] sm:text-xl text-[#8e8e8e] sm:leading-normal"
            >
            ...
            >
                ...
                <Button className="cursor-pointer flex flex-row items-center h-14 px-5 text-md md:text-lg font-semibold bg-[#121212] border border-[#2a2a2a] text-white hover:bg-[#171717]">
